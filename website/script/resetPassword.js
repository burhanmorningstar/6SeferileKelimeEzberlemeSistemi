...
sendEmailForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        messageDiv.textContent = 'Şifre sıfırlama işlemi sırasında bir hata oluştu.';
        messageDiv.style.display = 'block';
    }
});
...
resetForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        console.error('Şifre sıfırlama işlemi sırasında bir hata oluştu:', error);
        messageDiv.textContent = 'Şifre sıfırlama işlemi sırasında bir hata oluştu: ' + error.message;
        messageDiv.style.display = 'block';
    }
});
